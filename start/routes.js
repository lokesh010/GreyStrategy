...
Route.group(() => {
  ...
  .prefix("/dashboard/work-philosophy")
  .middleware(["auth:session"]);
// news
Route.group(() => {
  Route.get("/create", ({ view }) =>
    view.render("forms.createblogform", {
      title: "Create News",
...
Route.group(() => {
  ...
  .prefix("/dashboard/social-posts")
  .middleware(["auth:session"]);
// projects
Route.group(() => {
  Route.get("/create", ({ view }) =>
    view.render("forms.createprojectform", {
...
Route.group(() => {
  Route.get("/create", ({ view }) =>
    view.render("forms.createtestimonialform", {
...
Route.group(() => {
  ...
  .prefix("/dashboard/credentials")
  .middleware(["auth:session"]);
// newsletter
Route.group(() => {
  Route.post("/", "NewsletterController.create");
  Route.delete(":id", "NewsletterController.destroy").middleware([
    "auth:session",
  ]);
}).prefix("/newsletter");
// search
